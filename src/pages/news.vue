		...
		<div class="navbar no-border">
		  <div class="navbar-inner back-white">
			...
			<f7-subnavbar class="tabbar no-border">
				<f7-link tab-link="#system-news" active >
					<span>系统消息</span>
				</f7-link>
			    <f7-link tab-link="#my-news">
			        <span>我的消息</span>
			    </f7-link>
				<f7-link tab-link="#my-comments">
					<span>我的评论</span>
				</f7-link>
				<f7-link tab-link="#comment-me">
					<span>评论我的</span>
				</f7-link>
			</f7-subnavbar>  
		  </div>
	                    ...
	                    <ul class="news-page">
	                        <li class="my-com-list" v-for="(news,index) in newslist[3]">
	                            ...
	                            <div class="about">
	                                ...
	                                <div class="right-side">
	                                    <p class="username">{{news.user.name}}<span class="date"><timeago :since="news.dateline*1000" :max-time="86400" :format='tool.convertDate'></timeago></span></p>
	                                    <div class="content">{{news.content.reply}}</div>
	                                </div>
	                            </div>
	                        </li>
